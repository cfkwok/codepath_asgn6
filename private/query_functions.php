<?php
  ...
  function validate_user($user, $errors=array()) {
    ...
    $containsLowercase  = preg_match('/[a-z]/', $user['password']);
    $containsUppercase  = preg_match('/[A-Z]/', $user['password']);
    $containsDigit   = preg_match('/\d/', $user['password']);
    $containsSpecial = preg_match('/[^a-zA-Z\d]/', $user['password']);
    ...
    } elseif(!$containsLowercase || !$containsUppercase || !$containsDigit || !$containsSpecial) {
